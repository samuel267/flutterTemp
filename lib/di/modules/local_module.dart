...
import 'package:boilerplate/data/local/datasources/authDao.dart';
...
class LocalModule extends NetworkModule {
  ...
  @provide
  @singleton
  AuthDao provideAuthDao() => AuthDao(database);


  @provide
  @singleton
  AuthUserDao provideAuthUserDao() => AuthUserDao(database);
  ...
  AuthRepository provideAuthRepository(
   ...
   AuthUserDao authUserDao
      ...
      AuthRepository(authApi, preferenceHelper, authDao,authUserDao);
}
